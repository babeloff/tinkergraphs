...
**Task 4.1.2: TinkerPop compliance tests** [⏸️ Partially implemented, Phase 3 TODO]
*Managed using `pixi` (wraps `gradle`)*
...
** JVM : these tests should be run as java tests against the JVM implementation, the tests should be as close to the original java compliance tests as is possible.
** JS : while there are no official JavaScript compliance tests, we aim to closely follow the Java compliance tests.
** Python, Native : there is no official Python compliance tests, we aim to closely follow the Java compliance tests, these tests effectively validate the Native implementation as well.
