...
* Port existing TinkerPop test suites from Java to Kotlin
** https://github.com/apache/tinkerpop/tree/master/tinkergraph-gremlin/src/test
** This may already be mostly complete
